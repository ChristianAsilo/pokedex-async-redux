import 'package:pokedex_async_redux/api/model/api_client.dart';
...
class PokemonApi {
  ...
  Future<PokemonDetails> getPokemonDetails({required String index}) async {
    final uri = baseUri.replace(path: '${baseUri.path}/pokemon/$index');
